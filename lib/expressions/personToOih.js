...
module.exports.getExpression = (msg) => {
  ...
  const wiceAddresses = {
    ...
    ...(msg.body.data.private_street_number && { streetNumber: msg.body.data.private_street_number }),
    ...(msg.body.data.private_zip_code && { zipcode: msg.body.data.private_zip_code }),
  ...
  const contactData = wiceContactData.filter(cd => cd.value);
