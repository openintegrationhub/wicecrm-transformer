...
module.exports.getExpression = msg => {
  ...
  console.log('TYPE: ', typeof msg.body.private_street);
  ...
  const expression = {
    ...
    addresses: [{
      ...
      streetNumber: ((msg.body.private_street === null) || (msg.body.private_street === '')) ? '' : jsonata(`$number($split("${msg.body.private_street}", " ")[-1])`).evaluate()
      // unit: '',
